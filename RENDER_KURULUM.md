...
5. En az 32 rastgele karakterlik `ADMIN_SESSION_SECRET` ortam değişkenini ekleyin.
6. Başlangıç komutunu `python main.py` olarak bırakın ve yeniden deploy edin.
7. İlk açılışta `/ilk-kurulum` sayfasından firma ve ilk yönetici hesabını oluşturun.
8. Yönetici panelinde önce şube, sonra personel ekleyin.
